...
export function NavBar() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-stone-200/70 bg-surface/70 backdrop-blur-xl dark:border-stone-800/70">
          ...
          {links.map(({ href, label, icon: Icon, exact }) => {
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-1.5 rounded-full px-3 py-2 text-sm font-medium transition-all active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 sm:px-4 ${
                  isActive
